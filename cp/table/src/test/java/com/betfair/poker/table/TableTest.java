    ...
    public void testTheWholeThing() throws Exception {
        ...
        for (int i = 0; i < seats.size(); i++) {
            ...
            System.out.println("Hand::: "
                    + seat.getPlayer().getHand().getCards().length);
        }
        ...
        System.out.println("Community card size "
                + game.getActiveSeats().get(3).getPlayer().getHand()
        ...
        System.out.println("Is tuen of joe "
                + game.getActiveSeats().get(1).isTurn());
        System.out.println("Allowed action of player joe "
                + game.getAllowedActions(seats.get(1).getPlayer()));
